  ...
  return (
    <section className="relative flex-1 flex flex-col items-center justify-start overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full pt-12 md:pt-16">
        {/* Badge */}
        <motion.div {...fadeUp(0, 10, 0.5)} className="mb-6">
        ...
        <motion.p
          {...fadeUp(0.2, 16, 0.6)}
          className="mt-4 text-center text-base md:text-lg text-muted-foreground max-w-[650px] leading-relaxed font-body px-6"
        >
          {t("hero.sub")}
        </motion.p>
        ...
        <motion.div {...fadeUp(0.3, 16, 0.6)} className="mt-5 flex items-center gap-3">
          <a href="#contact" className="inline-flex items-center justify-center rounded-full bg-primary text-primary-foreground hover:bg-primary/90 px-6 py-3 text-sm font-medium font-body transition-colors">
            {t("nav.cta")}
          </a>
          <Button
            variant="ghost"
        ...
        <motion.div
          {...fadeUp(0.5, 30, 0.8)}
          className="mt-8 w-full max-w-5xl flex justify-center px-4"
        >
          <DashboardPreview />
        </motion.div>
      </div>
